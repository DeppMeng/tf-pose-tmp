...
class Config:
    ...
    ## model setting
    model = 'full_rnet_concat_124'
    backbone = 'w8' # 'w32', 'w48'
    init_model = osp.join(pretrain_model_dir, 'full_rnet_concat_124_' + backbone + '.ckpt')
    hrnet_config = osp.join(root_dir, 'full_rnet_concat_124', 'configs', backbone + '.cfg')
